      ...
      <div className='relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16'>
          ...
          <div>
            ...
            <motion.div
              ...
              <a
                ...
                className='flex w-full max-w-full items-center justify-center gap-2 rounded-md bg-primary px-6 py-2.5 font-label text-sm font-bold tracking-wide text-primary-foreground transition-opacity hover:opacity-90 dark:bg-white dark:text-black dark:hover:bg-zinc-200 sm:w-auto'>
                <Icon icon='lucide:github' className='h-3.5 w-3.5' />
                Deploy with Docker
              </a>
              <button
                onClick={() => (user ? navigateHome() : openAuthModal('register'))}
                className='flex w-full max-w-full items-center justify-center gap-2 rounded-md bg-content2 px-6 py-2.5 font-label text-sm font-bold tracking-wide text-foreground transition-colors hover:bg-content3 dark:bg-white/10 dark:text-white dark:hover:bg-white/15 sm:w-auto'>
                <Icon icon='lucide:flask-conical' className='h-3.5 w-3.5 text-default-600 dark:text-white/70' />
          ...
          <motion.div
            ...
            {/* ─ API Terminal card — colors match docs CodeBlock (#0A0E16 / #10131C) ─ */}
            <div className='overflow-hidden rounded-lg' style={{ background: '#050505' }}>
              ...
              <div
                ...
                <span className='font-mono text-[10px]' style={{ color: '#5A5E6E' }}>
                  0.82s
                </span>
              </div>
            </div>

            {/* ─ PDF Preview strip — same palette ─ */}
            <div className='overflow-hidden rounded-lg' style={{ background: '#050505' }}>
              <div className='flex items-center gap-2 px-4 py-2' style={{ background: '#0b0b0b' }}>
