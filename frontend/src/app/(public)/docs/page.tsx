      ...
      <DocLayout
        ...
        <div className='flex flex-col gap-16'>
          ...
          <Section id='overview' title='Overview' icon='solar:document-text-bold'>
            ...
            <div className='mb-8'>
              {/* Pill Tabs */}
              <div className='mb-4 inline-flex rounded-md bg-content2 p-1 ring-1 ring-default-200 dark:ring-white/5'>
                <button
                  onClick={() => setActiveEndpoint('template')}
                  className={`flex items-center gap-2 rounded px-3 py-1.5 text-[12.5px] font-semibold transition-all ${
                    activeEndpoint === 'template'
                      ? 'bg-content1 text-primary ring-1 ring-default-200 dark:ring-white/5'
              ...
              <div className='overflow-hidden rounded-md bg-content2 ring-1 ring-default-200 dark:ring-white/5'>
                ...
                <div className='p-5'>
                  ...
                  {/* Endpoint URL */}
                  <div className='mb-4 flex items-center gap-2 rounded-md bg-content1 px-3 py-2.5 ring-1 ring-default-200 dark:ring-white/5'>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      <p className='text-[12.5px] font-medium text-foreground'>
                        Package: <code className='font-mono text-[12px] text-primary'>qorstack-sdk</code>
                      </p>
